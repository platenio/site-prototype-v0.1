  ...
  return (
    <Layout cover={coverSrc} sidebarLeft={false} sidebarRight={false}>
      <div className="pb-32">
        ...
        <div className="mt-8 -mx-8 px-8 flex flex-wrap justify-start items-stretch bg-gradient-to-tl from-orange-400 via-red-500 to-pink-500">
          <div className="flex-intial w-full sm:w-48 mt-8 sm:-mb-4">
            <div className="relative w-48 max-w-full mx-auto rounded-lg shadow-xl overflow-hidden">
              {BookOverlay && (
                <span
          ...
          <div className="flex-1 flex items-center p-8 text-white">
            <div className="flex-row justify-start">
              ...
              <p className="mt-2 font-bold italic text-lg">{blurb}</p>
              <p className="mt-2">
                <b>{author}</b>
              </p>

              <Link className="btn-light table mt-8" to={slug + `contents/`}>
            ...
            <ul className="flex-intial w-full sm:w-48 mb-8 sm:mb-0 flex flex-wrap justify-center items-stretch">
              {meta.language && (
                <li className={temp}>
                  ...
                  <small className={tempLabel}>Language</small>
              ...
              {meta.audience && (
                <li className={temp}>
                  ...
                  <small className={tempLabel}>Audience</small>
              ...
              {meta.published && (
                <li className={temp}>
                  ...
                  <small className={tempLabel}>Published</small>
                  <p className={tempValue}>{meta.published}</p>
                </li>
              )}
