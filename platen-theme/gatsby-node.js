...
//   actions.createTypes([
//     `
//     interface MdxPost implements Node {
//       id: ID!
//       slug: String!
...
//     interface MdxBook implements Node {
//       id: ID!
//       slug: String!
//       lastUpdated: Date! @dateformat
...
//     interface MdxAuthor implements Node {
//       id: ID!
//       slug: String!
//       lastUpdated: Date! @dateformat
...
//   if (node.relativePath && node.sourceInstanceName === "post") {
...
//   }
//   // --- Book Pages ---
//   else if (node.relativePath && node.sourceInstanceName === "book") {
//       const slug = createFilePath({ node, getNode })
...
//   // --- Author Pages ---
//   } else if (node.relativePath && node.sourceInstanceName === "author") {
//       const slug = createFilePath({ node, getNode })
...
//     // let queryAuthors = await graphql(`
//     //   query {
//     //     allMdxAuthor(filter: { fields: { type: { eq: "author" } } }) {
//     //       edges {
//     //         node {
//     //           id
//     //           fields {
